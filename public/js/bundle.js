...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2VyZ2lva2FtZXRzIiwiYSI6ImNsZDRhOTdueDBxaWkzcW9nNzY3YndtMjQifQ.0rx9A1APna5MBBeCZ6n9Mg';
...
var stripe = Stripe('pk_test_51MT3bzCqe4MtsRp8aD6LT3SAG55M000oiVlS09WFo1220ysZIuX1gYOSz7Hx16TtM73I2y3bauOhiMOadCdCIgG800l4earpFZ');
...
if (updateUserDataForm) {
  updateUserDataForm.addEventListener('submit',
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return (0, _updateUser.updateSettings)(form, 'data');
